...
public abstract class AbstParser<T> implements IParser<T> {
    ...
    protected String addDefaultDaysIfNeeded(String part) {
    ...
    protected List<String> expandDayRange(String dayGroup) {
    ...
    protected List<String> merge(Map<Days, String> progress){
    ...
    protected String buildDayRangeString(List<Days> days, Days first) {
